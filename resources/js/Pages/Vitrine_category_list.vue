        ...
        <div class="max-w-[1520px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            >
                <Link
                    ...
                    class="group relative h-64 rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-emerald-900/20 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-emerald-500/50 block"
                >
                    <!-- Background Image -->
